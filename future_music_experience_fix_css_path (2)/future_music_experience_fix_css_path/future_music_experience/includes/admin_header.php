...
<link rel="stylesheet" href="<?= url('assets/css/style.css?v=1.0.1'); ?>">
</head>
<body>
<div class="admin-shell">
    <aside class="admin-sidebar">
        ...
        <nav>
            ...
            <a href="<?= url('admin/events.php'); ?>"> Event</a>
            <a href="<?= url('admin/artists.php'); ?>"> Artist</a>
            <a href="<?= url('admin/users.php'); ?>"> User</a>
            <a href="<?= url('admin/tickets.php'); ?>"> Ticket</a>
            <a href="<?= url('admin/venues.php'); ?>"> Venue</a>
